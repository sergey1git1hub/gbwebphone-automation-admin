...
public class AdminCreateDeleteDepartment {
    ...
    public void testAdminCanDeleteDepartment() {
        ...
        anyElementByText.findUpperInput(anyElementByText.NAME).setValue(nameOfDepartment).pressEnter();
        anyElementByText.findCollectionByColumn(2).find(text(nameOfDepartment)).click();

...
public class Enabled {
    ...
    private SelenideElement enabledSort = $(By.xpath(".//*[@id='queueDataForm:queueDataTable_head']//span[text()='Enabled']"));
    private SelenideElement enabledIs = $(By.xpath(".//*[@id='queueDataForm:queueDataTable_head']//select"));
    private ElementsCollection enabledCollection = $$(By.xpath(".//*[@id='queueDataForm:queueDataTable_data']//td[5]"));
